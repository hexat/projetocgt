...
import cgt.controller.ConfigScreenController;
import cgt.controller.ConfigWorldController;
import cgt.controller.ScreenController;
import cgt.controller.WorldController;
        ...
        setOnSelectionChanged(new EventHandler<Event>() {
            ...
            public void handle(Event event) {
                if (((Tab) event.getSource()).isSelected()) {
                    ...
                    if (screen instanceof CGTScreen) {
                        configAccordion.getPanes().add(ConfigScreenController.getNode((CGTScreen) screen));
                    } else {
                        configAccordion.getPanes().add(ConfigWorldController.getNode((CGTGameWorld) screen));
                    }
                }
            }
        });
