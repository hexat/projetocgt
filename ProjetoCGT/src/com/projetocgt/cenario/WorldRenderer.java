...
public class WorldRenderer {
	...
	public void render() {
		...
		//Dsenha o personagem
		drawPersonagem();
		//Desenha o texto com a posição do personagem
		printTexto();
		spriteBatch.end();
		if (debug)
			drawDebug();
