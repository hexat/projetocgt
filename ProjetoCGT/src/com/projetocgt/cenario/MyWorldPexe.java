...
public class MyWorldPexe {
	...
	public void configuracaoActionActor(CGTActor personagemCGTActor){
		...
		CGTAnimation animationDamage = new CGTAnimation(personagemCGTActor);
		animationDamage.setSpriteLine(5);
		animationDamage.addStatePolicy(StatePolicy.DAMAGE);
		animationDamage.setSpriteVelocity(0.2f);
		animationDamage.setAnimationPolicy(AnimationPolicy.LOOP_PINGPONG);

		personagemCGTActor.getAnimarions().add(animationDamage);
