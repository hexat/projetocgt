...
public class ButtonPad extends HUDComponent {
	...
	public ButtonPad(float tamanho){		
		...
		buttonUp.setRelativeX(0.076f*tamanho);
		...
		buttonDown.setRelativeX(0.076f*tamanho);
		...
		buttonLeft.setRelativeX(0.036f*tamanho);
		...
		buttonRight.setRelativeX(0.105f*tamanho);
